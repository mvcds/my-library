Tho [[13 - Security sometimes requires the programmer to add some complexity in order to protect the application]], using [[SQL Parameter Binding|Parameter Binding]] actually makes the code [[Clean Code|cleaner]].
