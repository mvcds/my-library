...
| `#fact`        | States a factual claim, usually sourced from a book or resource. Usually relate to memorizing |
...
| `summary:`      | The name of the book/article                                          |
| `organization:` | Moving files around                                                   |
