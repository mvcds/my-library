When facing a problem, we need to understand its causes, each can have causes on their own, you have to dig deep until you find the [[Root Cause]] of your problem in order to propose solutions.
