A mental model that explains the situation where a good intention can be misinterpreted  and create a worse scenario than when you started (low quality testing):  
