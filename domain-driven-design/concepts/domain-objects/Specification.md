...
A spec is normally expressed as a [[Value Object|VO]], and configured by a [[Factory]]. It states a [[Constraint]] on the state of <u>another</u> object, so it can be used to check if that object satisfies some criteria.
