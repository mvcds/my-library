[[1 - The cargo shipment system]] will use a [[5 - Layered Architecture]] as a way to create 3 [[System|Systems]] that act on the work done by the [[2 - Domain Model]] layer:
