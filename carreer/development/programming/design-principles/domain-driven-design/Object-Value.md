Contrary to an [[Entity]], an [[Object]]-[[Value]] does not have an [[identity]] by its own, so to make one apart from another, we have to consider all of its properties at once.
