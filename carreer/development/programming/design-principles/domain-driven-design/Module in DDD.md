...
- The name of the Module should be derived directly from the [[domain-driven-design/concepts/Ubiquitous Language|Ubiquitous Language]] and should reflect an important concept from the [[Domain]] rather than just group related objects
