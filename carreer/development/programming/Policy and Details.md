...
> All [[software]] [[System|Systems]] can be [[composition|]] into two major elements: policy and details. The policy element embodies all the [[business]] rules and procedures. The policy is where the true [[my-library/philosofy/Value|Value]] of the system lives.
