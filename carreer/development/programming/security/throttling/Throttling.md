A way to limit calls to [[Application Programming Interface|API]], similar to speed limits, so that it can prevent attacks like [[Distributed Denial of Service|DDoS]] or misusage.
