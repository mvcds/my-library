A pull API waits until a consumer asks for the next value. A good example in [[Javascript]] is an Iterable, such as the [[object]] produced by a [[generator function]]
